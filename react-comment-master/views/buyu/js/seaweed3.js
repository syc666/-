...
seaweedObj.prototype.draw = function(a){
    switch(a){
    	case 0:this.x=240;this.y=500;break;
    	case 1:this.x=400;this.y=300;break;
    	case 2:this.x=200,this.y=200;break;
    	case 3:this.x=10,this.y=260;break;
    	case 4:this.x=270,this.y=400;break;
    	case 5:this.x=460;this.y=400;break;
...
four.onclick=function(){
  if (score.gameover==true&&score.scoreNum>15000) {
    four.href="pass4.html"
  }
}