...
seaweedObj.prototype.draw = function(a){
    switch(a){
    	case 0:this.x=140;this.y=400;break;
    	case 1:this.x=100;this.y=400;break;
    	case 2:this.x=500,this.y=200;break;
    	case 3:this.x=120,this.y=300;break;
    	case 4:this.x=170,this.y=400;break;
    	case 5:this.x=500;this.y=400;break;
...
three.onclick=function(){
  if (score.gameover==true&&score.scoreNum>12000) {
    three.href="pass3.html"
